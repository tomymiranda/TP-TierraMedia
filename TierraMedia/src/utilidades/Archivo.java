...
public class Archivo {
	...
	private <T> Promocion crearPromocion(String nombre, List<Atraccion> atracciones, String tipo, T datoExtra,
		...
		switch (tipo) {
		case "Porcentual":
			return new Porcentual(nombre, atracciones, descripcion, (int) datoExtra);
		case "Absoluta":
			return new Absoluta(nombre, (int) datoExtra, atracciones, descripcion);
		case "AxB":
			return new AxB(nombre, atracciones, (String) datoExtra);
		default:
			return null;
		}
	}
